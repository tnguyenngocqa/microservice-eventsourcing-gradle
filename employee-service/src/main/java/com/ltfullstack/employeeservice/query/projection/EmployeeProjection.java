...
public class EmployeeProjection {
    ...
    public List<EmployeeResponseModel> handle(GetAllEmployeeQuery query) {
        List<Employee> list = employeeRepository.findAllByIsDisciplined(query.getIsDisciplined());
    ...
    public EmployeeResponseModel handle(GetDetailEmployeeQuery query) throws Exception {
        ...
        Employee employee = employeeRepository.findById(query.getId()).orElseThrow(() -> new Exception("Employee not found with BookId: " + query.getId()));
